...
let baseUrl = "http://api.blairq.top/"
// 本地api
...
export function getRecomMV(limit = 30) {
    // return axios.get(`http://web.peakchao.top:250/video/getVideoBanner?page=${1}`);
    // return axios.get(`http://web.peakchao.top:250/video/getVideoList?size=33`);
    return axios({
        baseURL: baseUrl,
...
//     return axios.get(`http://web.peakchao.top:250/video/getVideoList?search=${name}`);
// }