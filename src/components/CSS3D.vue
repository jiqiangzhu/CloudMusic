    ...
    data() {
        return {
            iconlist: [
                ...
                { pic: require('../assets/iconlist/4.jpg'), txt: "img04" },
                { pic: require('../assets/iconlist/5.jpg'), txt: "img05" },
                { pic: require('../assets/iconlist/6.jpg'), txt: "img06" },
