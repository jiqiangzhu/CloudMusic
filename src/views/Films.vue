...
<script>
import {
    Skeleton as VanSkeleton, Toast, Button as VanButton, Col as VanCol, Row as VanRow, Search as VanSearch,
    Grid as VanGrid, GridItem as VanGridItem, Image as VanImage
} from 'vant';
